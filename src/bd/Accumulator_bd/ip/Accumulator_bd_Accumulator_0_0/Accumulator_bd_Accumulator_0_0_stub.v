...
module Accumulator_bd_Accumulator_0_0(sys_clk, sys_rst_n, accu_en, accu_finished, 
  ...
  s_axis_tready, s_axis_tdata, m_axis_aresetn, m_axis_aclk, m_axis_tvalid, m_axis_tready, 
  m_axis_tdata)
/* synthesis syn_black_box black_box_pad_pin="sys_clk,sys_rst_n,accu_en,accu_finished,step_debug[7:0],accu_length_debug[31:0],sum_debug[31:0],s_axis_aresetn,s_axis_aclk,s_axis_tvalid,s_axis_tready,s_axis_tdata[63:0],m_axis_aresetn,m_axis_aclk,m_axis_tvalid,m_axis_tready,m_axis_tdata[63:0]" */;
  input sys_clk;
  input sys_rst_n;
  input accu_en;
