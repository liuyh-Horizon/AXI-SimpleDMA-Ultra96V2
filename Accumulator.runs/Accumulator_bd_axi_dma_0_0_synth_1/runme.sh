...
HD_PWD='/home/yuhaoliu/Projects/Verilog/AXI-SimpleDMA-Ultra96V2/Accumulator.runs/Accumulator_bd_axi_dma_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Accumulator_bd_axi_dma_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Accumulator_bd_axi_dma_0_0.tcl
