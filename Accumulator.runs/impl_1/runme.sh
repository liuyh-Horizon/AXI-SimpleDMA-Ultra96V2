...
HD_PWD='/home/yuhao_liu/Projects/Hardware/FPGA/Ultra96V2/AXI-SimpleDMA/Accumulator.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Accumulator_bd_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Accumulator_bd_wrapper.tcl -notrace
