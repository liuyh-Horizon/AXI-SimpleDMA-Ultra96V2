...
EAStep vivado -log Accumulator_bd_Accumulator_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Accumulator_bd_Accumulator_0_0.tcl
