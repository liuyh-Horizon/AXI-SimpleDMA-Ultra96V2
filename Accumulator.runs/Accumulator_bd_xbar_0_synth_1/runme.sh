...
HD_PWD='/home/yuhao_liu/Projects/Hardware/FPGA/Ultra96V2/AXI-SimpleDMA/Accumulator.runs/Accumulator_bd_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Accumulator_bd_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Accumulator_bd_xbar_0.tcl
